...
pub struct ApiV2010AccountSipSipDomain {
    ...
    #[serde(rename = "voice_status_callback_method", skip_serializing_if = "Option::is_none")]
    pub voice_status_callback_method: Option<VoiceStatusCallbackMethod>,
    /// The URL that we call with status updates
    #[serde(rename = "voice_status_callback_url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "emergency_calling_enabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "emergency_caller_sid", skip_serializing_if = "Option::is_none")]
