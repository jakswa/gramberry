...
pub async fn create_account(configuration: &configuration::Configuration, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010Account, Error<CreateAccountError>> {
...
pub async fn create_call_feedback_summary(configuration: &configuration::Configuration, account_sid: &str, start_date: String, end_date: String, include_subaccounts: Option<bool>, status_callback: Option<&str>, status_callback_method: Option<&str>) -> Result<crate::models::ApiV2010AccountCallCallFeedbackSummary, Error<CreateCallFeedbackSummaryError>> {
    let local_var_configuration = configuration;
...
pub async fn create_incoming_phone_number_assigned_add_on(configuration: &configuration::Configuration, account_sid: &str, resource_sid: &str, installed_add_on_sid: &str) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn, Error<CreateIncomingPhoneNumberAssignedAddOnError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_local(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, api_version: Option<&str>, friendly_name: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>, identity_sid: Option<&str>, address_sid: Option<&str>, emergency_status: Option<&str>, emergency_address_sid: Option<&str>, trunk_sid: Option<&str>, voice_receive_mode: Option<&str>, bundle_sid: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal, Error<CreateIncomingPhoneNumberLocalError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_mobile(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, api_version: Option<&str>, friendly_name: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>, identity_sid: Option<&str>, address_sid: Option<&str>, emergency_status: Option<&str>, emergency_address_sid: Option<&str>, trunk_sid: Option<&str>, voice_receive_mode: Option<&str>, bundle_sid: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile, Error<CreateIncomingPhoneNumberMobileError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_toll_free(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, api_version: Option<&str>, friendly_name: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>, identity_sid: Option<&str>, address_sid: Option<&str>, emergency_status: Option<&str>, emergency_address_sid: Option<&str>, trunk_sid: Option<&str>, voice_receive_mode: Option<&str>, bundle_sid: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree, Error<CreateIncomingPhoneNumberTollFreeError>> {
    let local_var_configuration = configuration;
...
pub async fn create_message(configuration: &configuration::Configuration, account_sid: &str, to: &str, status_callback: Option<&str>, application_sid: Option<&str>, max_price: Option<f32>, provide_feedback: Option<bool>, attempt: Option<i32>, validity_period: Option<i32>, force_delivery: Option<bool>, content_retention: Option<&str>, address_retention: Option<&str>, smart_encoded: Option<bool>, persistent_action: Option<Vec<String>>, schedule_type: Option<&str>, send_at: Option<String>, send_as_mms: Option<bool>, from: Option<&str>, messaging_service_sid: Option<&str>, body: Option<&str>, media_url: Option<Vec<String>>) -> Result<crate::models::ApiV2010AccountMessage, Error<CreateMessageError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_message_feedback(configuration: &configuration::Configuration, account_sid: &str, message_sid: &str, outcome: Option<&str>) -> Result<crate::models::ApiV2010AccountMessageMessageFeedback, Error<CreateMessageFeedbackError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_new_key(configuration: &configuration::Configuration, account_sid: &str, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountNewKey, Error<CreateNewKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn create_new_signing_key(configuration: &configuration::Configuration, account_sid: &str, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountNewSigningKey, Error<CreateNewSigningKeyError>> {
    let local_var_configuration = configuration;
...
/// Create a queue
pub async fn create_queue(configuration: &configuration::Configuration, account_sid: &str, friendly_name: &str, max_size: Option<i32>) -> Result<crate::models::ApiV2010AccountQueue, Error<CreateQueueError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_auth_calls_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, credential_list_sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping, Error<CreateSipAuthCallsCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_auth_calls_ip_access_control_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, ip_access_control_list_sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping, Error<CreateSipAuthCallsIpAccessControlListMappingError>> {
    let local_var_configuration = configuration;
...
/// Create a new credential list mapping resource
pub async fn create_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, credential_list_sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping, Error<CreateSipAuthRegistrationsCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_credential(configuration: &configuration::Configuration, account_sid: &str, credential_list_sid: &str, username: &str, password: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialListSipCredential, Error<CreateSipCredentialError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_credential_list(configuration: &configuration::Configuration, account_sid: &str, friendly_name: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialList, Error<CreateSipCredentialListError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, credential_list_sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipCredentialListMapping, Error<CreateSipCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
/// Create a new Domain
pub async fn create_sip_domain(configuration: &configuration::Configuration, account_sid: &str, domain_name: &str, friendly_name: Option<&str>, voice_url: Option<&str>, voice_method: Option<&str>, voice_fallback_url: Option<&str>, voice_fallback_method: Option<&str>, voice_status_callback_url: Option<&str>, voice_status_callback_method: Option<&str>, sip_registration: Option<bool>, emergency_calling_enabled: Option<bool>, secure: Option<bool>, byoc_trunk_sid: Option<&str>, emergency_caller_sid: Option<&str>) -> Result<crate::models::ApiV2010AccountSipSipDomain, Error<CreateSipDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_ip_access_control_list(configuration: &configuration::Configuration, account_sid: &str, friendly_name: &str) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlList, Error<CreateSipIpAccessControlListError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_ip_access_control_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, ip_access_control_list_sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping, Error<CreateSipIpAccessControlListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_ip_address(configuration: &configuration::Configuration, account_sid: &str, ip_access_control_list_sid: &str, friendly_name: &str, ip_address: &str, cidr_prefix_length: Option<i32>) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlListSipIpAddress, Error<CreateSipIpAddressError>> {
    let local_var_configuration = configuration;
...
/// Create a Siprec
pub async fn create_siprec(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, name: Option<&str>, connector_name: Option<&str>, track: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, parameter1_name: Option<&str>, parameter1_value: Option<&str>, parameter2_name: Option<&str>, parameter2_value: Option<&str>, parameter3_name: Option<&str>, parameter3_value: Option<&str>, parameter4_name: Option<&str>, parameter4_value: Option<&str>, parameter5_name: Option<&str>, parameter5_value: Option<&str>, parameter6_name: Option<&str>, parameter6_value: Option<&str>, parameter7_name: Option<&str>, parameter7_value: Option<&str>, parameter8_name: Option<&str>, parameter8_value: Option<&str>, parameter9_name: Option<&str>, parameter9_value: Option<&str>, parameter10_name: Option<&str>, parameter10_value: Option<&str>, parameter11_name: Option<&str>, parameter11_value: Option<&str>, parameter12_name: Option<&str>, parameter12_value: Option<&str>, parameter13_name: Option<&str>, parameter13_value: Option<&str>, parameter14_name: Option<&str>, parameter14_value: Option<&str>, parameter15_name: Option<&str>, parameter15_value: Option<&str>, parameter16_name: Option<&str>, parameter16_value: Option<&str>, parameter17_name: Option<&str>, parameter17_value: Option<&str>, parameter18_name: Option<&str>, parameter18_value: Option<&str>, parameter19_name: Option<&str>, parameter19_value: Option<&str>, parameter20_name: Option<&str>, parameter20_value: Option<&str>, parameter21_name: Option<&str>, parameter21_value: Option<&str>, parameter22_name: Option<&str>, parameter22_value: Option<&str>, parameter23_name: Option<&str>, parameter23_value: Option<&str>, parameter24_name: Option<&str>, parameter24_value: Option<&str>, parameter25_name: Option<&str>, parameter25_value: Option<&str>, parameter26_name: Option<&str>, parameter26_value: Option<&str>, parameter27_name: Option<&str>, parameter27_value: Option<&str>, parameter28_name: Option<&str>, parameter28_value: Option<&str>, parameter29_name: Option<&str>, parameter29_value: Option<&str>, parameter30_name: Option<&str>, parameter30_value: Option<&str>, parameter31_name: Option<&str>, parameter31_value: Option<&str>, parameter32_name: Option<&str>, parameter32_value: Option<&str>, parameter33_name: Option<&str>, parameter33_value: Option<&str>, parameter34_name: Option<&str>, parameter34_value: Option<&str>, parameter35_name: Option<&str>, parameter35_value: Option<&str>, parameter36_name: Option<&str>, parameter36_value: Option<&str>, parameter37_name: Option<&str>, parameter37_value: Option<&str>, parameter38_name: Option<&str>, parameter38_value: Option<&str>, parameter39_name: Option<&str>, parameter39_value: Option<&str>, parameter40_name: Option<&str>, parameter40_value: Option<&str>, parameter41_name: Option<&str>, parameter41_value: Option<&str>, parameter42_name: Option<&str>, parameter42_value: Option<&str>, parameter43_name: Option<&str>, parameter43_value: Option<&str>, parameter44_name: Option<&str>, parameter44_value: Option<&str>, parameter45_name: Option<&str>, parameter45_value: Option<&str>, parameter46_name: Option<&str>, parameter46_value: Option<&str>, parameter47_name: Option<&str>, parameter47_value: Option<&str>, parameter48_name: Option<&str>, parameter48_value: Option<&str>, parameter49_name: Option<&str>, parameter49_value: Option<&str>, parameter50_name: Option<&str>, parameter50_value: Option<&str>, parameter51_name: Option<&str>, parameter51_value: Option<&str>, parameter52_name: Option<&str>, parameter52_value: Option<&str>, parameter53_name: Option<&str>, parameter53_value: Option<&str>, parameter54_name: Option<&str>, parameter54_value: Option<&str>, parameter55_name: Option<&str>, parameter55_value: Option<&str>, parameter56_name: Option<&str>, parameter56_value: Option<&str>, parameter57_name: Option<&str>, parameter57_value: Option<&str>, parameter58_name: Option<&str>, parameter58_value: Option<&str>, parameter59_name: Option<&str>, parameter59_value: Option<&str>, parameter60_name: Option<&str>, parameter60_value: Option<&str>, parameter61_name: Option<&str>, parameter61_value: Option<&str>, parameter62_name: Option<&str>, parameter62_value: Option<&str>, parameter63_name: Option<&str>, parameter63_value: Option<&str>, parameter64_name: Option<&str>, parameter64_value: Option<&str>, parameter65_name: Option<&str>, parameter65_value: Option<&str>, parameter66_name: Option<&str>, parameter66_value: Option<&str>, parameter67_name: Option<&str>, parameter67_value: Option<&str>, parameter68_name: Option<&str>, parameter68_value: Option<&str>, parameter69_name: Option<&str>, parameter69_value: Option<&str>, parameter70_name: Option<&str>, parameter70_value: Option<&str>, parameter71_name: Option<&str>, parameter71_value: Option<&str>, parameter72_name: Option<&str>, parameter72_value: Option<&str>, parameter73_name: Option<&str>, parameter73_value: Option<&str>, parameter74_name: Option<&str>, parameter74_value: Option<&str>, parameter75_name: Option<&str>, parameter75_value: Option<&str>, parameter76_name: Option<&str>, parameter76_value: Option<&str>, parameter77_name: Option<&str>, parameter77_value: Option<&str>, parameter78_name: Option<&str>, parameter78_value: Option<&str>, parameter79_name: Option<&str>, parameter79_value: Option<&str>, parameter80_name: Option<&str>, parameter80_value: Option<&str>, parameter81_name: Option<&str>, parameter81_value: Option<&str>, parameter82_name: Option<&str>, parameter82_value: Option<&str>, parameter83_name: Option<&str>, parameter83_value: Option<&str>, parameter84_name: Option<&str>, parameter84_value: Option<&str>, parameter85_name: Option<&str>, parameter85_value: Option<&str>, parameter86_name: Option<&str>, parameter86_value: Option<&str>, parameter87_name: Option<&str>, parameter87_value: Option<&str>, parameter88_name: Option<&str>, parameter88_value: Option<&str>, parameter89_name: Option<&str>, parameter89_value: Option<&str>, parameter90_name: Option<&str>, parameter90_value: Option<&str>, parameter91_name: Option<&str>, parameter91_value: Option<&str>, parameter92_name: Option<&str>, parameter92_value: Option<&str>, parameter93_name: Option<&str>, parameter93_value: Option<&str>, parameter94_name: Option<&str>, parameter94_value: Option<&str>, parameter95_name: Option<&str>, parameter95_value: Option<&str>, parameter96_name: Option<&str>, parameter96_value: Option<&str>, parameter97_name: Option<&str>, parameter97_value: Option<&str>, parameter98_name: Option<&str>, parameter98_value: Option<&str>, parameter99_name: Option<&str>, parameter99_value: Option<&str>) -> Result<crate::models::ApiV2010AccountCallSiprec, Error<CreateSiprecError>> {
    let local_var_configuration = configuration;
...
/// Create a Stream
pub async fn create_stream(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, url: &str, name: Option<&str>, track: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, parameter1_name: Option<&str>, parameter1_value: Option<&str>, parameter2_name: Option<&str>, parameter2_value: Option<&str>, parameter3_name: Option<&str>, parameter3_value: Option<&str>, parameter4_name: Option<&str>, parameter4_value: Option<&str>, parameter5_name: Option<&str>, parameter5_value: Option<&str>, parameter6_name: Option<&str>, parameter6_value: Option<&str>, parameter7_name: Option<&str>, parameter7_value: Option<&str>, parameter8_name: Option<&str>, parameter8_value: Option<&str>, parameter9_name: Option<&str>, parameter9_value: Option<&str>, parameter10_name: Option<&str>, parameter10_value: Option<&str>, parameter11_name: Option<&str>, parameter11_value: Option<&str>, parameter12_name: Option<&str>, parameter12_value: Option<&str>, parameter13_name: Option<&str>, parameter13_value: Option<&str>, parameter14_name: Option<&str>, parameter14_value: Option<&str>, parameter15_name: Option<&str>, parameter15_value: Option<&str>, parameter16_name: Option<&str>, parameter16_value: Option<&str>, parameter17_name: Option<&str>, parameter17_value: Option<&str>, parameter18_name: Option<&str>, parameter18_value: Option<&str>, parameter19_name: Option<&str>, parameter19_value: Option<&str>, parameter20_name: Option<&str>, parameter20_value: Option<&str>, parameter21_name: Option<&str>, parameter21_value: Option<&str>, parameter22_name: Option<&str>, parameter22_value: Option<&str>, parameter23_name: Option<&str>, parameter23_value: Option<&str>, parameter24_name: Option<&str>, parameter24_value: Option<&str>, parameter25_name: Option<&str>, parameter25_value: Option<&str>, parameter26_name: Option<&str>, parameter26_value: Option<&str>, parameter27_name: Option<&str>, parameter27_value: Option<&str>, parameter28_name: Option<&str>, parameter28_value: Option<&str>, parameter29_name: Option<&str>, parameter29_value: Option<&str>, parameter30_name: Option<&str>, parameter30_value: Option<&str>, parameter31_name: Option<&str>, parameter31_value: Option<&str>, parameter32_name: Option<&str>, parameter32_value: Option<&str>, parameter33_name: Option<&str>, parameter33_value: Option<&str>, parameter34_name: Option<&str>, parameter34_value: Option<&str>, parameter35_name: Option<&str>, parameter35_value: Option<&str>, parameter36_name: Option<&str>, parameter36_value: Option<&str>, parameter37_name: Option<&str>, parameter37_value: Option<&str>, parameter38_name: Option<&str>, parameter38_value: Option<&str>, parameter39_name: Option<&str>, parameter39_value: Option<&str>, parameter40_name: Option<&str>, parameter40_value: Option<&str>, parameter41_name: Option<&str>, parameter41_value: Option<&str>, parameter42_name: Option<&str>, parameter42_value: Option<&str>, parameter43_name: Option<&str>, parameter43_value: Option<&str>, parameter44_name: Option<&str>, parameter44_value: Option<&str>, parameter45_name: Option<&str>, parameter45_value: Option<&str>, parameter46_name: Option<&str>, parameter46_value: Option<&str>, parameter47_name: Option<&str>, parameter47_value: Option<&str>, parameter48_name: Option<&str>, parameter48_value: Option<&str>, parameter49_name: Option<&str>, parameter49_value: Option<&str>, parameter50_name: Option<&str>, parameter50_value: Option<&str>, parameter51_name: Option<&str>, parameter51_value: Option<&str>, parameter52_name: Option<&str>, parameter52_value: Option<&str>, parameter53_name: Option<&str>, parameter53_value: Option<&str>, parameter54_name: Option<&str>, parameter54_value: Option<&str>, parameter55_name: Option<&str>, parameter55_value: Option<&str>, parameter56_name: Option<&str>, parameter56_value: Option<&str>, parameter57_name: Option<&str>, parameter57_value: Option<&str>, parameter58_name: Option<&str>, parameter58_value: Option<&str>, parameter59_name: Option<&str>, parameter59_value: Option<&str>, parameter60_name: Option<&str>, parameter60_value: Option<&str>, parameter61_name: Option<&str>, parameter61_value: Option<&str>, parameter62_name: Option<&str>, parameter62_value: Option<&str>, parameter63_name: Option<&str>, parameter63_value: Option<&str>, parameter64_name: Option<&str>, parameter64_value: Option<&str>, parameter65_name: Option<&str>, parameter65_value: Option<&str>, parameter66_name: Option<&str>, parameter66_value: Option<&str>, parameter67_name: Option<&str>, parameter67_value: Option<&str>, parameter68_name: Option<&str>, parameter68_value: Option<&str>, parameter69_name: Option<&str>, parameter69_value: Option<&str>, parameter70_name: Option<&str>, parameter70_value: Option<&str>, parameter71_name: Option<&str>, parameter71_value: Option<&str>, parameter72_name: Option<&str>, parameter72_value: Option<&str>, parameter73_name: Option<&str>, parameter73_value: Option<&str>, parameter74_name: Option<&str>, parameter74_value: Option<&str>, parameter75_name: Option<&str>, parameter75_value: Option<&str>, parameter76_name: Option<&str>, parameter76_value: Option<&str>, parameter77_name: Option<&str>, parameter77_value: Option<&str>, parameter78_name: Option<&str>, parameter78_value: Option<&str>, parameter79_name: Option<&str>, parameter79_value: Option<&str>, parameter80_name: Option<&str>, parameter80_value: Option<&str>, parameter81_name: Option<&str>, parameter81_value: Option<&str>, parameter82_name: Option<&str>, parameter82_value: Option<&str>, parameter83_name: Option<&str>, parameter83_value: Option<&str>, parameter84_name: Option<&str>, parameter84_value: Option<&str>, parameter85_name: Option<&str>, parameter85_value: Option<&str>, parameter86_name: Option<&str>, parameter86_value: Option<&str>, parameter87_name: Option<&str>, parameter87_value: Option<&str>, parameter88_name: Option<&str>, parameter88_value: Option<&str>, parameter89_name: Option<&str>, parameter89_value: Option<&str>, parameter90_name: Option<&str>, parameter90_value: Option<&str>, parameter91_name: Option<&str>, parameter91_value: Option<&str>, parameter92_name: Option<&str>, parameter92_value: Option<&str>, parameter93_name: Option<&str>, parameter93_value: Option<&str>, parameter94_name: Option<&str>, parameter94_value: Option<&str>, parameter95_name: Option<&str>, parameter95_value: Option<&str>, parameter96_name: Option<&str>, parameter96_value: Option<&str>, parameter97_name: Option<&str>, parameter97_value: Option<&str>, parameter98_name: Option<&str>, parameter98_value: Option<&str>, parameter99_name: Option<&str>, parameter99_value: Option<&str>) -> Result<crate::models::ApiV2010AccountCallStream, Error<CreateStreamError>> {
    let local_var_configuration = configuration;
...
pub async fn create_token(configuration: &configuration::Configuration, account_sid: &str, ttl: Option<i32>) -> Result<crate::models::ApiV2010AccountToken, Error<CreateTokenError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_account(configuration: &configuration::Configuration, sid: &str) -> Result<crate::models::ApiV2010Account, Error<FetchAccountError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_address(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountAddress, Error<FetchAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_application(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountApplication, Error<FetchApplicationError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_authorized_connect_app(configuration: &configuration::Configuration, account_sid: &str, connect_app_sid: &str) -> Result<crate::models::ApiV2010AccountAuthorizedConnectApp, Error<FetchAuthorizedConnectAppError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_available_phone_number_country(configuration: &configuration::Configuration, account_sid: &str, country_code: &str) -> Result<crate::models::ApiV2010AccountAvailablePhoneNumberCountry, Error<FetchAvailablePhoneNumberCountryError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_balance(configuration: &configuration::Configuration, account_sid: &str) -> Result<crate::models::ApiV2010AccountBalance, Error<FetchBalanceError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_call(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountCall, Error<FetchCallError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_call_feedback(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str) -> Result<crate::models::ApiV2010AccountCallCallFeedback, Error<FetchCallFeedbackError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_call_feedback_summary(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountCallCallFeedbackSummary, Error<FetchCallFeedbackSummaryError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_call_notification(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountCallCallNotificationInstance, Error<FetchCallNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_call_recording(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountCallCallRecording, Error<FetchCallRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_conference(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountConference, Error<FetchConferenceError>> {
    let local_var_configuration = configuration;
...
/// Fetch an instance of a recording for a call
pub async fn fetch_conference_recording(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountConferenceConferenceRecording, Error<FetchConferenceRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_connect_app(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountConnectApp, Error<FetchConnectAppError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_incoming_phone_number(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumber, Error<FetchIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_incoming_phone_number_assigned_add_on(configuration: &configuration::Configuration, account_sid: &str, resource_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn, Error<FetchIncomingPhoneNumberAssignedAddOnError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_incoming_phone_number_assigned_add_on_extension(configuration: &configuration::Configuration, account_sid: &str, resource_sid: &str, assigned_add_on_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension, Error<FetchIncomingPhoneNumberAssignedAddOnExtensionError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_key(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountKey, Error<FetchKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_media(configuration: &configuration::Configuration, account_sid: &str, message_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountMessageMedia, Error<FetchMediaError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_member(configuration: &configuration::Configuration, account_sid: &str, queue_sid: &str, call_sid: &str) -> Result<crate::models::ApiV2010AccountQueueMember, Error<FetchMemberError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_message(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountMessage, Error<FetchMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_notification(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountNotificationInstance, Error<FetchNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_outgoing_caller_id(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountOutgoingCallerId, Error<FetchOutgoingCallerIdError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_participant(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, call_sid: &str) -> Result<crate::models::ApiV2010AccountConferenceParticipant, Error<FetchParticipantError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_queue(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountQueue, Error<FetchQueueError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_recording(configuration: &configuration::Configuration, account_sid: &str, sid: &str, include_soft_deleted: Option<bool>) -> Result<crate::models::ApiV2010AccountRecording, Error<FetchRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_recording_add_on_result(configuration: &configuration::Configuration, account_sid: &str, reference_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountRecordingRecordingAddOnResult, Error<FetchRecordingAddOnResultError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_recording_add_on_result_payload(configuration: &configuration::Configuration, account_sid: &str, reference_sid: &str, add_on_result_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountRecordingRecordingAddOnResultRecordingAddOnResultPayload, Error<FetchRecordingAddOnResultPayloadError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_recording_transcription(configuration: &configuration::Configuration, account_sid: &str, recording_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountRecordingRecordingTranscription, Error<FetchRecordingTranscriptionError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_short_code(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountShortCode, Error<FetchShortCodeError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn fetch_signing_key(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSigningKey, Error<FetchSigningKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_auth_calls_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping, Error<FetchSipAuthCallsCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_auth_calls_ip_access_control_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping, Error<FetchSipAuthCallsIpAccessControlListMappingError>> {
    let local_var_configuration = configuration;
...
/// Fetch a specific instance of a credential list mapping
pub async fn fetch_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping, Error<FetchSipAuthRegistrationsCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_credential(configuration: &configuration::Configuration, account_sid: &str, credential_list_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialListSipCredential, Error<FetchSipCredentialError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_credential_list(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialList, Error<FetchSipCredentialListError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_credential_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipCredentialListMapping, Error<FetchSipCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_domain(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomain, Error<FetchSipDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_ip_access_control_list(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlList, Error<FetchSipIpAccessControlListError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_ip_access_control_list_mapping(configuration: &configuration::Configuration, account_sid: &str, domain_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipDomainSipIpAccessControlListMapping, Error<FetchSipIpAccessControlListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_sip_ip_address(configuration: &configuration::Configuration, account_sid: &str, ip_access_control_list_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlListSipIpAddress, Error<FetchSipIpAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_transcription(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountTranscription, Error<FetchTranscriptionError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_usage_trigger(configuration: &configuration::Configuration, account_sid: &str, sid: &str) -> Result<crate::models::ApiV2010AccountUsageUsageTrigger, Error<FetchUsageTriggerError>> {
    let local_var_configuration = configuration;
...
pub async fn list_call(configuration: &configuration::Configuration, account_sid: &str, to: Option<&str>, from: Option<&str>, parent_call_sid: Option<&str>, status: Option<&str>, start_time: Option<String>, start_time2: Option<String>, start_time3: Option<String>, end_time: Option<String>, end_time2: Option<String>, end_time3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListCallResponse, Error<ListCallError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn list_call_notification(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, log: Option<i32>, message_date: Option<String>, message_date2: Option<String>, message_date3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListCallNotificationResponse, Error<ListCallNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn list_call_recording(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, date_created: Option<String>, date_created2: Option<String>, date_created3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListCallRecordingResponse, Error<ListCallRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn list_conference(configuration: &configuration::Configuration, account_sid: &str, date_created: Option<String>, date_created2: Option<String>, date_created3: Option<String>, date_updated: Option<String>, date_updated2: Option<String>, date_updated3: Option<String>, friendly_name: Option<&str>, status: Option<&str>, page_size: Option<i32>) -> Result<crate::models::ListConferenceResponse, Error<ListConferenceError>> {
    let local_var_configuration = configuration;
...
/// Retrieve a list of recordings belonging to the call used to make the request
pub async fn list_conference_recording(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, date_created: Option<String>, date_created2: Option<String>, date_created3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListConferenceRecordingResponse, Error<ListConferenceRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn list_media(configuration: &configuration::Configuration, account_sid: &str, message_sid: &str, date_created: Option<String>, date_created2: Option<String>, date_created3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListMediaResponse, Error<ListMediaError>> {
    let local_var_configuration = configuration;
...
pub async fn list_message(configuration: &configuration::Configuration, account_sid: &str, to: Option<&str>, from: Option<&str>, date_sent: Option<String>, date_sent2: Option<String>, date_sent3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListMessageResponse, Error<ListMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn list_notification(configuration: &configuration::Configuration, account_sid: &str, log: Option<i32>, message_date: Option<String>, message_date2: Option<String>, message_date3: Option<String>, page_size: Option<i32>) -> Result<crate::models::ListNotificationResponse, Error<ListNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn list_recording(configuration: &configuration::Configuration, account_sid: &str, date_created: Option<String>, date_created2: Option<String>, date_created3: Option<String>, call_sid: Option<&str>, conference_sid: Option<&str>, include_soft_deleted: Option<bool>, page_size: Option<i32>) -> Result<crate::models::ListRecordingResponse, Error<ListRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_account(configuration: &configuration::Configuration, sid: &str, friendly_name: Option<&str>, status: Option<&str>) -> Result<crate::models::ApiV2010Account, Error<UpdateAccountError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_address(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>, customer_name: Option<&str>, street: Option<&str>, city: Option<&str>, region: Option<&str>, postal_code: Option<&str>, emergency_enabled: Option<bool>, auto_correct_address: Option<bool>) -> Result<crate::models::ApiV2010AccountAddress, Error<UpdateAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn update_call_feedback(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, quality_score: Option<i32>, issue: Option<Vec<crate::models::CallFeedbackEnumIssues>>) -> Result<crate::models::ApiV2010AccountCallCallFeedback, Error<UpdateCallFeedbackError>> {
    let local_var_configuration = configuration;
...
pub async fn update_call_recording(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str, status: &str, pause_behavior: Option<&str>) -> Result<crate::models::ApiV2010AccountCallCallRecording, Error<UpdateCallRecordingError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_conference(configuration: &configuration::Configuration, account_sid: &str, sid: &str, status: Option<&str>, announce_url: Option<&str>, announce_method: Option<&str>) -> Result<crate::models::ApiV2010AccountConference, Error<UpdateConferenceError>> {
    let local_var_configuration = configuration;
...
pub async fn update_conference_recording(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, sid: &str, status: &str, pause_behavior: Option<&str>) -> Result<crate::models::ApiV2010AccountConferenceConferenceRecording, Error<UpdateConferenceRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_incoming_phone_number(configuration: &configuration::Configuration, account_sid: &str, sid: &str, account_sid2: Option<&str>, api_version: Option<&str>, friendly_name: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>, emergency_status: Option<&str>, emergency_address_sid: Option<&str>, trunk_sid: Option<&str>, voice_receive_mode: Option<&str>, identity_sid: Option<&str>, address_sid: Option<&str>, bundle_sid: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumber, Error<UpdateIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_key(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountKey, Error<UpdateKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn update_member(configuration: &configuration::Configuration, account_sid: &str, queue_sid: &str, call_sid: &str, url: &str, method: Option<&str>) -> Result<crate::models::ApiV2010AccountQueueMember, Error<UpdateMemberError>> {
    let local_var_configuration = configuration;
...
pub async fn update_message(configuration: &configuration::Configuration, account_sid: &str, sid: &str, body: Option<&str>, status: Option<&str>) -> Result<crate::models::ApiV2010AccountMessage, Error<UpdateMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn update_outgoing_caller_id(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountOutgoingCallerId, Error<UpdateOutgoingCallerIdError>> {
    let local_var_configuration = configuration;
...
pub async fn update_participant(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, call_sid: &str, muted: Option<bool>, hold: Option<bool>, hold_url: Option<&str>, hold_method: Option<&str>, announce_url: Option<&str>, announce_method: Option<&str>, wait_url: Option<&str>, wait_method: Option<&str>, beep_on_exit: Option<bool>, end_conference_on_exit: Option<bool>, coaching: Option<bool>, call_sid_to_coach: Option<&str>) -> Result<crate::models::ApiV2010AccountConferenceParticipant, Error<UpdateParticipantError>> {
    let local_var_configuration = configuration;
...
pub async fn update_payments(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str, idempotency_key: &str, status_callback: &str, capture: Option<&str>, status: Option<&str>) -> Result<crate::models::ApiV2010AccountCallPayments, Error<UpdatePaymentsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_queue(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>, max_size: Option<i32>) -> Result<crate::models::ApiV2010AccountQueue, Error<UpdateQueueError>> {
    let local_var_configuration = configuration;
...
pub async fn update_short_code(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>, api_version: Option<&str>, sms_url: Option<&str>, sms_method: Option<&str>, sms_fallback_url: Option<&str>, sms_fallback_method: Option<&str>) -> Result<crate::models::ApiV2010AccountShortCode, Error<UpdateShortCodeError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_signing_key(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountSigningKey, Error<UpdateSigningKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_credential(configuration: &configuration::Configuration, account_sid: &str, credential_list_sid: &str, sid: &str, password: Option<&str>) -> Result<crate::models::ApiV2010AccountSipSipCredentialListSipCredential, Error<UpdateSipCredentialError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_credential_list(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialList, Error<UpdateSipCredentialListError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_ip_access_control_list(configuration: &configuration::Configuration, account_sid: &str, sid: &str, friendly_name: &str) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlList, Error<UpdateSipIpAccessControlListError>> {
    let local_var_configuration = configuration;
...
pub async fn update_siprec(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str, status: &str) -> Result<crate::models::ApiV2010AccountCallSiprec, Error<UpdateSiprecError>> {
    let local_var_configuration = configuration;
...
pub async fn update_stream(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, sid: &str, status: &str) -> Result<crate::models::ApiV2010AccountCallStream, Error<UpdateStreamError>> {
    let local_var_configuration = configuration;
...
pub async fn update_usage_trigger(configuration: &configuration::Configuration, account_sid: &str, sid: &str, callback_method: Option<&str>, callback_url: Option<&str>, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountUsageUsageTrigger, Error<UpdateUsageTriggerError>> {
    let local_var_configuration = configuration;
